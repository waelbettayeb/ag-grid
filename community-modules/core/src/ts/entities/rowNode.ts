...
export class RowNode<TData = any> implements IEventEmitter {
    ...
    public static ID_PREFIX_ROW_GROUP: 'row-group-' = 'row-group-';
    public static ID_PREFIX_TOP_PINNED: 't-' = 't-';
    public static ID_PREFIX_BOTTOM_PINNED: 'b-' = 'b-';

    private static OBJECT_ID_SEQUENCE = 0;

    public static EVENT_ROW_SELECTED: 'rowSelected' = 'rowSelected';
    public static EVENT_DATA_CHANGED: 'dataChanged' = 'dataChanged';
    public static EVENT_CELL_CHANGED: 'cellChanged' = 'cellChanged';
    public static EVENT_ALL_CHILDREN_COUNT_CHANGED: 'allChildrenCountChanged' = 'allChildrenCountChanged';
    public static EVENT_MASTER_CHANGED: 'masterChanged' = 'masterChanged';
    public static EVENT_GROUP_CHANGED: 'groupChanged' = 'groupChanged';
    public static EVENT_MOUSE_ENTER: 'mouseEnter' = 'mouseEnter';
    public static EVENT_MOUSE_LEAVE: 'mouseLeave' = 'mouseLeave';
    public static EVENT_HEIGHT_CHANGED: 'heightChanged' = 'heightChanged';
    public static EVENT_TOP_CHANGED: 'topChanged' = 'topChanged';
    public static EVENT_DISPLAYED_CHANGED: 'displayedChanged' = 'displayedChanged';
    public static EVENT_FIRST_CHILD_CHANGED: 'firstChildChanged' = 'firstChildChanged';
    public static EVENT_LAST_CHILD_CHANGED: 'lastChildChanged' = 'lastChildChanged';
    public static EVENT_CHILD_INDEX_CHANGED: 'childIndexChanged' = 'childIndexChanged';
    public static EVENT_ROW_INDEX_CHANGED: 'rowIndexChanged' = 'rowIndexChanged';
    public static EVENT_EXPANDED_CHANGED: 'expandedChanged' = 'expandedChanged';
    public static EVENT_HAS_CHILDREN_CHANGED: 'hasChildrenChanged' = 'hasChildrenChanged';
    public static EVENT_SELECTABLE_CHANGED: 'selectableChanged' = 'selectableChanged';
    public static EVENT_UI_LEVEL_CHANGED: 'uiLevelChanged' = 'uiLevelChanged';
    public static EVENT_HIGHLIGHT_CHANGED: 'rowHighlightChanged' = 'rowHighlightChanged';
    public static EVENT_DRAGGING_CHANGED: 'draggingChanged' = 'draggingChanged';
...
export type RowNodeEventType = {
    [property in keyof typeof RowNode]: (typeof RowNode[property]) extends string ? typeof RowNode[property] : never
}[keyof typeof RowNode]